        ...
        <div class="mt-5" style="margin-bottom:100px;">
            <div class="container mb-5" style="display:flex; gap:20px; justify-content:center;">
                <div style="display:flex; flex-direction:column; width: calc(50% - 10px); gap:20px;">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">We open up your <u>horizon</u>!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3 text-bg-primary" style="max-width: 540px;">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Already have an account?</h5> <br>
                                    <p class="card-text">Explore now!</p>
                                    <a href="login.php" class="btn" style="background-color: white; color: #0275d8">Login Here!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card p-3" style="width: calc(50% - 10px); border: solid #f0ad4e">
                    <h3 style="position:absolute;right:20px">Register</h3>
                    <form class="mt-5" action="" method="post">
                        ...
                        <div style="display:flex; justify-content:center">
                            <input type="submit" name="register" id="login" class="btn btn-warning mb-3" value="Register" style="width:100%">
                        </div>
                    </form>
                    ...
                    <?php
                        if(isset($_POST['register'])){
                            ...
                            if($pass == $confirmation){
                                ...
                                // Query INSERT DATETIME apa cok?
                                $sql = "INSERT INTO users(user_name, user_email, user_password, creation_date, authorization) VALUES('$name', '$email', '$hash', NOW(), '$authorization');";
                                $registration = $connection -> query($sql);

                                if($registration){
                                    $balance = "INSERT INTO wallets(user_id, balance) VALUES(LAST_INSERT_ID(), 0);";
                                    $wallet = $connection -> query($balance);
                                    if($wallet){
